		...
		$no++;
		 ?>
			<tr>
				...
				<?php 
				if ($data['gambar'] == '') { ?>
				<td class="tampilan"><img style="width: 60px; height: 60px;" src="../../gambar/foto/default.jpg"></td>	
				<?php
				} else { ?>
				<td class="tampilan"><img style="width: 60px; height: 60px;" src="../../gambar/foto/<?php echo $data['gambar']; ?>"></td>
				<?php
				}
				 ?>
				<td class="tampilan">

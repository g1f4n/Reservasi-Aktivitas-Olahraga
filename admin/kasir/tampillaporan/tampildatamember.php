...
<form action="../../cetaklaporan/cetak-datamember.php" target="_BLANK" method="POST">
<table class="tabel2">
	<tr>
		<th>Kode Anggota</th>
		<th>Nama Lengkap</th>
		 ...
		 ?>
			<tr>
				...
				<?php
				 ...
				 ?>
				<td class="tampilan">
					<a target="_blank" href="tampillaporan-solo/laporanmember.php?kodemember=<?php echo $data['kodemember']; ?>"><i class="fa fa-print" title="Cetak"></i></a>
				</td>
			</tr>

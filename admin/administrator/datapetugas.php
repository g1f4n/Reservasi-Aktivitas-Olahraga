	...
	<?php 
		...
		while ($data = mysql_fetch_array($sql)) { ?>
			<tr>
				...
				<td class="tampilan">
					<a href="?page=editdatapetugas&kodeuser=<?php echo $data['kodeuser']; ?>"><i class="fa fa-edit" title="Edit"></i></a>
					<a href="hapus/hapusdatapetugas.php?kodeuser=<?php echo $data['kodeuser']; ?>" onclick="return confirm('Anda Yakin Ingin Menghapus Data?');"><i class="fa fa-trash-o" title="Hapus"></i></a>
				</td>
			</tr>
		<?php
		}

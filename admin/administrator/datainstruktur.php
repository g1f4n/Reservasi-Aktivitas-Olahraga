	...
	<?php 
		...
		while ($data = mysql_fetch_array($sql)) { ?>
			<tr>
				...
				<td class="tampilan">
					<a href="?page=editdatainstruktur&kodeinstruktur=<?php echo $data['kodeinstruktur']; ?>"><i class="fa fa-edit" title="Edit"></i></a>
					<a href="hapus/hapusdatainstruktur.php?kodeinstruktur=<?php echo $data['kodeinstruktur']; ?>" onclick="return confirm('Anda Yakin Ingin Menghapus Data?');"><i class="fa fa-trash-o" title="Hapus"></i></a>
				</td>
			</tr>
		<?php
		}

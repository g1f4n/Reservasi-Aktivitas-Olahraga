<?php
	...
	$Lapor = "SELECT kodeuser, nama, username, level FROM admin ORDER by kodeuser";
	...
	$Header= array(
		array("label"=>"Kode Pengguna", "length"=>40, "align"=>"L"),
		array("label"=>"Nama Lengkap", "length"=>60, "align"=>"L"),
		array("label"=>"Nama Pengguna", "length"=>50, "align"=>"L"),
		array("label"=>"Level", "length"=>40, "align"=>"L"),
	);
